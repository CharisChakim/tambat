...
/** Logo Tambat: jangkar miring, tali melilit batangnya lalu menambat ke sebuah
 *  server (titik hijau = online) — sesi ditautkan ke seberang. Warna jangkar
 *  ikut `currentColor`; tali & titik server berwarna tetap. */
